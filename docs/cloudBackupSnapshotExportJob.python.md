...
cloudBackupSnapshotExportJob.CloudBackupSnapshotExportJob(
  ...
  project_id: str,
  snapshot_id: str,
  custom_data: typing.Union[IResolvable, typing.List[CloudBackupSnapshotExportJobCustomData]] = None
)
```
