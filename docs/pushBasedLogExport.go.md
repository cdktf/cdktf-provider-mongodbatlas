...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/pushbasedlogexport"
...
&pushbasedlogexport.PushBasedLogExportConfig {
	...
	ProjectId: *string,
	PrefixPath: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8.pushBasedLogExport.PushBasedLogExportTimeouts,
}
```
