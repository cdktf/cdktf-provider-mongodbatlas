...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3/cloudprovideraccessauthorization"
...
&cloudprovideraccessauthorization.CloudProviderAccessAuthorizationConfig {
	...
	ProjectId: *string,
	RoleId: *string,
	Aws: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3.cloudProviderAccessAuthorization.CloudProviderAccessAuthorizationAws,
	Id: *string,
}
```
