...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4/privatelinkendpoint"
...
&privatelinkendpoint.PrivatelinkEndpointConfig {
	...
	Region: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4.privatelinkEndpoint.PrivatelinkEndpointTimeouts,
}
```
