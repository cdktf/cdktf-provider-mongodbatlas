...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5/privatelinkendpoint"
...
&privatelinkendpoint.PrivatelinkEndpointConfig {
	...
	Region: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5.privatelinkEndpoint.PrivatelinkEndpointTimeouts,
}
```
