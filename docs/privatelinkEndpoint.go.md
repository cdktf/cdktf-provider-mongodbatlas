...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/privatelinkendpoint"
...
&privatelinkendpoint.PrivatelinkEndpointConfig {
	...
	Region: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8.privatelinkEndpoint.PrivatelinkEndpointTimeouts,
}
```
