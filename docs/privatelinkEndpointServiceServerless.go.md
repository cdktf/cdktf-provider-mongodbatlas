...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5/privatelinkendpointserviceserverless"
...
&privatelinkendpointserviceserverless.PrivatelinkEndpointServiceServerlessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5.privatelinkEndpointServiceServerless.PrivatelinkEndpointServiceServerlessTimeouts,
}
```
