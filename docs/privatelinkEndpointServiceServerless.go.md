...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/privatelinkendpointserviceserverless"
...
&privatelinkendpointserviceserverless.PrivatelinkEndpointServiceServerlessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8.privatelinkEndpointServiceServerless.PrivatelinkEndpointServiceServerlessTimeouts,
}
```
