...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4/privatelinkendpointserviceserverless"
...
&privatelinkendpointserviceserverless.PrivatelinkEndpointServiceServerlessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4.privatelinkEndpointServiceServerless.PrivatelinkEndpointServiceServerlessTimeouts,
}
```
