...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5/datalake"
...
&datalake.DataLakeConfig {
	...
	Name: *string,
	ProjectId: *string,
	DataProcessRegion: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v5.dataLake.DataLakeDataProcessRegion,
	Id: *string,
}
```
