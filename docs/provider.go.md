...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4/provider"
...
&provider.MongodbatlasProviderConfig {
	Alias: *string,
	AssumeRole: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4.provider.MongodbatlasProviderAssumeRole,
