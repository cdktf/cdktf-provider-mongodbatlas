...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v2/projectipaccesslist"
...
| <code><a href="#@cdktf/provider-mongodbatlas.projectIpAccessList.ProjectIpAccessList.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&projectipaccesslist.ProjectIpAccessListConfig {
	...
	Id: *string,
	IpAddress: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v2.projectIpAccessList.ProjectIpAccessListTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-mongodbatlas.projectIpAccessList.ProjectIpAccessListConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
