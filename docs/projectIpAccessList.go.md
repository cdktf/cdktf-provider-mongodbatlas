...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/projectipaccesslist"
...
&projectipaccesslist.ProjectIpAccessListConfig {
	...
	Comment: *string,
	IpAddress: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8.projectIpAccessList.ProjectIpAccessListTimeouts,
}
```
