...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3/privatelinkendpointservice"
...
&privatelinkendpointservice.PrivatelinkEndpointServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3.privatelinkEndpointService.PrivatelinkEndpointServiceTimeouts,
}
```
