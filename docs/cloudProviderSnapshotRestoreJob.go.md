...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4/cloudprovidersnapshotrestorejob"
...
&cloudprovidersnapshotrestorejob.CloudProviderSnapshotRestoreJobConfig {
	...
	DeliveryTypeConfig: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v4.cloudProviderSnapshotRestoreJob.CloudProviderSnapshotRestoreJobDeliveryTypeConfig,
	Id: *string,
}
```
