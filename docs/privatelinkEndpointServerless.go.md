...
```go
import "github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3/privatelinkendpointserverless"
...
&privatelinkendpointserverless.PrivatelinkEndpointServerlessConfig {
	...
	ProviderName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v3.privatelinkEndpointServerless.PrivatelinkEndpointServerlessTimeouts,
}
```
