...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.4/docs/resources/stream_connection
...
export class StreamConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.4/docs/resources/stream_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.4/docs/resources/stream_connection mongodbatlas_stream_connection} Resource
  *
  * @param scope The scope in which to define this construct
