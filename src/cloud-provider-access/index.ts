// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.14.0/docs/resources/cloud_provider_access
...
export function cloudProviderAccessFeatureUsagesToHclTerraform(struct?: CloudProviderAccessFeatureUsages): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CloudProviderAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProviderAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.14.0/docs/resources/cloud_provider_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // iam_assumed_role_arn - computed: true, optional: true, required: false
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      iam_assumed_role_arn: {
        value: cdktf.stringToHclTerraform(this._iamAssumedRoleArn),
        isBlock: false,
        type: "simple",
