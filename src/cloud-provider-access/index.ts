...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.12.3/docs/resources/cloud_provider_access
...
export class CloudProviderAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProviderAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.12.3/docs/resources/cloud_provider_access#import import section} in the documentation of this resource for the id to use
