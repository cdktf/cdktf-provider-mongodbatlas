// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/serverless_instance
...
export function serverlessInstanceLinksToHclTerraform(struct?: ServerlessInstanceLinks | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServerlessInstanceLinksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // rel - computed: true, optional: true, required: false
  private _rel?: string; 
  public get rel() {
...
export function serverlessInstanceTagsToHclTerraform(struct?: ServerlessInstanceTags | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServerlessInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerlessInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/serverless_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/serverless_instance mongodbatlas_serverless_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      provider_settings_backing_provider_name: {
        value: cdktf.stringToHclTerraform(this._providerSettingsBackingProviderName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      provider_settings_provider_name: {
        value: cdktf.stringToHclTerraform(this._providerSettingsProviderName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      tags: {
        ...
        isBlock: true,
        type: "set",
        storageClassType: "ServerlessInstanceTagsList",
      },
    };
