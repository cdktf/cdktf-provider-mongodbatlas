...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.28.0/docs/resources/serverless_instance
...
export class ServerlessInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerlessInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.28.0/docs/resources/serverless_instance#import import section} in the documentation of this resource for the id to use
