...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.27.0/docs/resources/online_archive
...
export class OnlineArchive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnlineArchive that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.27.0/docs/resources/online_archive#import import section} in the documentation of this resource for the id to use
