// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.14.0/docs/resources/online_archive
...
export interface OnlineArchiveConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly dataProcessRegion?: OnlineArchiveDataProcessRegion[] | cdktf.IResolvable;
  /**
...
export function onlineArchiveDataProcessRegionToTerraform(struct?: OnlineArchiveDataProcessRegion | cdktf.IResolvable): any {
...
export class OnlineArchiveDataProcessRegionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OnlineArchiveDataProcessRegion | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OnlineArchiveDataProcessRegion | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OnlineArchiveDataProcessRegionList extends cdktf.ComplexList {
  public internalValue? : OnlineArchiveDataProcessRegion[] | cdktf.IResolvable
  ...
  */
  public get(index: number): OnlineArchiveDataProcessRegionOutputReference {
    return new OnlineArchiveDataProcessRegionOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class OnlineArchive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnlineArchive that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.14.0/docs/resources/online_archive#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // data_process_region - computed: true, optional: true, required: false
  private _dataProcessRegion = new OnlineArchiveDataProcessRegionList(this, "data_process_region", false);
  public get dataProcessRegion() {
    return this._dataProcessRegion;
  }
  public putDataProcessRegion(value: OnlineArchiveDataProcessRegion[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      data_process_region: cdktf.listMapper(onlineArchiveDataProcessRegionToTerraform, false)(this._dataProcessRegion.internalValue),
