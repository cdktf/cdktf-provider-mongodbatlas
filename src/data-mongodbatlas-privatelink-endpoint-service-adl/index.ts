...
export class DataMongodbatlasPrivatelinkEndpointServiceAdl extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataMongodbatlasPrivatelinkEndpointServiceAdl to import
  * @param importFromId The id of the existing DataMongodbatlasPrivatelinkEndpointServiceAdl that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.12.1/docs/data-sources/privatelink_endpoint_service_adl#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataMongodbatlasPrivatelinkEndpointServiceAdl to import is found
  */
