...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/data-sources/api_key_project_assignments
...
export class DataMongodbatlasApiKeyProjectAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasApiKeyProjectAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/data-sources/api_key_project_assignments#import import section} in the documentation of this resource for the id to use
