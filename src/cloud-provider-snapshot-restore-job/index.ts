...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.9.0/docs/resources/cloud_provider_snapshot_restore_job
...
export interface CloudProviderSnapshotRestoreJobConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly deliveryType?: { [key: string]: string };
  /**
  ...
  */
  readonly deliveryTypeConfig?: CloudProviderSnapshotRestoreJobDeliveryTypeConfig;
}
...
export function cloudProviderSnapshotRestoreJobDeliveryTypeConfigToTerraform(struct?: CloudProviderSnapshotRestoreJobDeliveryTypeConfigOutputReference | CloudProviderSnapshotRestoreJobDeliveryTypeConfig): any {
...
export class CloudProviderSnapshotRestoreJobDeliveryTypeConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CloudProviderSnapshotRestoreJobDeliveryTypeConfig | undefined {
  ...
  public set internalValue(value: CloudProviderSnapshotRestoreJobDeliveryTypeConfig | undefined) {
    if (value === undefined) {
...
*/
export class CloudProviderSnapshotRestoreJob extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "mongodbatlas_cloud_provider_snapshot_restore_job";
  ...
  * @param options CloudProviderSnapshotRestoreJobConfig
  */
  public constructor(scope: Construct, id: string, config: CloudProviderSnapshotRestoreJobConfig) {
    super(scope, id, {
      terraformResourceType: 'mongodbatlas_cloud_provider_snapshot_restore_job',
  ...
  private _deliveryType?: { [key: string]: string }; 
  public get deliveryType() {
    return this.getStringMapAttribute('delivery_type');
  }
  public set deliveryType(value: { [key: string]: string }) {
  ...
  private _deliveryTypeConfig = new CloudProviderSnapshotRestoreJobDeliveryTypeConfigOutputReference(this, "delivery_type_config");
  public get deliveryTypeConfig() {
    return this._deliveryTypeConfig;
  }
  public putDeliveryTypeConfig(value: CloudProviderSnapshotRestoreJobDeliveryTypeConfig) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      delivery_type: cdktf.hashMapper(cdktf.stringToTerraform)(this._deliveryType),
      id: cdktf.stringToTerraform(this._id),
      project_id: cdktf.stringToTerraform(this._projectId),
      snapshot_id: cdktf.stringToTerraform(this._snapshotId),
      delivery_type_config: cloudProviderSnapshotRestoreJobDeliveryTypeConfigToTerraform(this._deliveryTypeConfig.internalValue),
    };
  }
}
