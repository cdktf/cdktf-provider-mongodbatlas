...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/resources/encryption_at_rest
...
export interface EncryptionAtRestConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly enabledForSearchNodes?: boolean | cdktf.IResolvable;
  /**
...
export class EncryptionAtRest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EncryptionAtRest that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/resources/encryption_at_rest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/resources/encryption_at_rest mongodbatlas_encryption_at_rest} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: EncryptionAtRestConfig) {
    ...
    this._enabledForSearchNodes = config.enabledForSearchNodes;
  ...
  // enabled_for_search_nodes - computed: true, optional: true, required: false
  private _enabledForSearchNodes?: boolean | cdktf.IResolvable; 
  public get enabledForSearchNodes() {
    return this.getBooleanAttribute('enabled_for_search_nodes');
  }
  public set enabledForSearchNodes(value: boolean | cdktf.IResolvable) {
    this._enabledForSearchNodes = value;
  }
  public resetEnabledForSearchNodes() {
    this._enabledForSearchNodes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enabledForSearchNodesInput() {
    return this._enabledForSearchNodes;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      enabled_for_search_nodes: cdktf.booleanToTerraform(this._enabledForSearchNodes),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      enabled_for_search_nodes: {
        value: cdktf.booleanToHclTerraform(this._enabledForSearchNodes),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
