...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.33.0/docs/data-sources/stream_privatelink_endpoints
...
export class DataMongodbatlasStreamPrivatelinkEndpoints extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasStreamPrivatelinkEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.33.0/docs/data-sources/stream_privatelink_endpoints#import import section} in the documentation of this resource for the id to use
