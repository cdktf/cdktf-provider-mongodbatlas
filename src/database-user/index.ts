// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.32.0/docs/resources/database_user
...
export class DatabaseUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.32.0/docs/resources/database_user#import import section} in the documentation of this resource for the id to use
