...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/network_peering
...
export class NetworkPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/network_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs/resources/network_peering mongodbatlas_network_peering} Resource
  *
  * @param scope The scope in which to define this construct
