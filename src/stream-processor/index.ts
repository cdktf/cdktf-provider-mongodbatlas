...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.32.0/docs/resources/stream_processor
...
export class StreamProcessor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.32.0/docs/resources/stream_processor#import import section} in the documentation of this resource for the id to use
