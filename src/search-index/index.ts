...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.40.0/docs/resources/search_index
...
export class SearchIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SearchIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.40.0/docs/resources/search_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.40.0/docs/resources/search_index mongodbatlas_search_index} Resource
  *
  * @param scope The scope in which to define this construct
