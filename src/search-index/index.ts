// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.25.0/docs/resources/search_index
...
export class SearchIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SearchIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.25.0/docs/resources/search_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.25.0/docs/resources/search_index mongodbatlas_search_index} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SearchIndexConfig) {
    ...
    this._storedSource = config.storedSource;
  ...
  // stored_source - computed: false, optional: true, required: false
  private _storedSource?: string; 
  public get storedSource() {
    return this.getStringAttribute('stored_source');
  }
  public set storedSource(value: string) {
    this._storedSource = value;
  }
  public resetStoredSource() {
    this._storedSource = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get storedSourceInput() {
    return this._storedSource;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stored_source: cdktf.stringToTerraform(this._storedSource),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stored_source: {
        value: cdktf.stringToHclTerraform(this._storedSource),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
