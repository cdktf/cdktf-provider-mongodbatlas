...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/resources/federated_database_instance
...
export function federatedDatabaseInstanceCloudProviderConfigAzureToTerraform(struct?: FederatedDatabaseInstanceCloudProviderConfigAzureOutputReference | FederatedDatabaseInstanceCloudProviderConfigAzure): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function federatedDatabaseInstanceCloudProviderConfigAzureToHclTerraform(struct?: FederatedDatabaseInstanceCloudProviderConfigAzureOutputReference | FederatedDatabaseInstanceCloudProviderConfigAzure): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FederatedDatabaseInstanceCloudProviderConfigAzureOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FederatedDatabaseInstanceCloudProviderConfigAzure | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._roleId !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: FederatedDatabaseInstanceCloudProviderConfigAzure | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._roleId = undefined;
    }
...
export interface FederatedDatabaseInstanceCloudProviderConfig {
  ...
  */
  readonly azure?: FederatedDatabaseInstanceCloudProviderConfigAzure;
}
...
export function federatedDatabaseInstanceCloudProviderConfigToTerraform(struct?: FederatedDatabaseInstanceCloudProviderConfigOutputReference | FederatedDatabaseInstanceCloudProviderConfig): any {
  ...
  return {
    ...
    azure: federatedDatabaseInstanceCloudProviderConfigAzureToTerraform(struct!.azure),
  }
}
...
export function federatedDatabaseInstanceCloudProviderConfigToHclTerraform(struct?: FederatedDatabaseInstanceCloudProviderConfigOutputReference | FederatedDatabaseInstanceCloudProviderConfig): any {
  ...
  const attrs = {
    ...
    azure: {
      value: federatedDatabaseInstanceCloudProviderConfigAzureToHclTerraform(struct!.azure),
      isBlock: true,
      type: "list",
      storageClassType: "FederatedDatabaseInstanceCloudProviderConfigAzureList",
    },
  };
...
export class FederatedDatabaseInstanceCloudProviderConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _azure = new FederatedDatabaseInstanceCloudProviderConfigAzureOutputReference(this, "azure");
  public get azure() {
    return this._azure;
  }
  public putAzure(value: FederatedDatabaseInstanceCloudProviderConfigAzure) {
...
export class FederatedDatabaseInstanceStorageDatabasesCollectionsDataSourcesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // collection_regex - computed: true, optional: true, required: false
  ...
  // database_regex - computed: true, optional: true, required: false
  ...
  // provenance_field_name - computed: true, optional: true, required: false
  ...
  // store_name - computed: true, optional: true, required: false
...
export class FederatedDatabaseInstanceStorageStoresReadPreferenceOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // max_staleness_seconds - computed: true, optional: true, required: false
...
export class FederatedDatabaseInstanceStorageStoresOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // additional_storage_classes - computed: true, optional: true, required: false
...
export class FederatedDatabaseInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FederatedDatabaseInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/resources/federated_database_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/resources/federated_database_instance mongodbatlas_federated_database_instance} Resource
  *
  * @param scope The scope in which to define this construct
