// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.8.2/docs/data-sources/cloud_provider_snapshots
...
export interface DataMongodbatlasCloudProviderSnapshotsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataMongodbatlasCloudProviderSnapshotsResults {
}

export function dataMongodbatlasCloudProviderSnapshotsResultsToTerraform(struct?: DataMongodbatlasCloudProviderSnapshotsResults): any {
...
export class DataMongodbatlasCloudProviderSnapshotsResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataMongodbatlasCloudProviderSnapshotsResults | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataMongodbatlasCloudProviderSnapshotsResults | undefined) {
    if (value === undefined) {
...
export class DataMongodbatlasCloudProviderSnapshotsResultsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataMongodbatlasCloudProviderSnapshotsResultsOutputReference {
    return new DataMongodbatlasCloudProviderSnapshotsResultsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataMongodbatlasCloudProviderSnapshots extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "mongodbatlas_cloud_provider_snapshots";
  ...
  * @param options DataMongodbatlasCloudProviderSnapshotsConfig
  */
  public constructor(scope: Construct, id: string, config: DataMongodbatlasCloudProviderSnapshotsConfig) {
    super(scope, id, {
      terraformResourceType: 'mongodbatlas_cloud_provider_snapshots',
  ...
  private _results = new DataMongodbatlasCloudProviderSnapshotsResultsList(this, "results", false);
  public get results() {
