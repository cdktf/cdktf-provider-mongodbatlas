// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.20.0/docs/data-sources/federated_settings
...
export class DataMongodbatlasFederatedSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasFederatedSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.20.0/docs/data-sources/federated_settings#import import section} in the documentation of this resource for the id to use
