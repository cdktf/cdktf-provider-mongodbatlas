// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.27.0/docs/resources/stream_privatelink_endpoint
...
export class StreamPrivatelinkEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamPrivatelinkEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.27.0/docs/resources/stream_privatelink_endpoint#import import section} in the documentation of this resource for the id to use
