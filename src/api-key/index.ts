...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/resources/api_key
...
export class ApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/resources/api_key#import import section} in the documentation of this resource for the id to use
