// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs
...
export class MongodbatlasProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MongodbatlasProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.17.2/docs mongodbatlas} Resource
  *
  * @param scope The scope in which to define this construct
