...
// https://registry.terraform.io/providers/mongodb/mongodbatlas/1.25.0/docs
...
export class MongodbatlasProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MongodbatlasProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.25.0/docs#import import section} in the documentation of this resource for the id to use
